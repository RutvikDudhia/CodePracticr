...
public class Distance {
	...
	public void calculateDistance(String abc)
	{
		if(abc.length()==24)
		{
		...
		System.out.println("RedValue = "+String.valueOf(blueValue));
		
		System.out.println(calculateEucledian(redValue,greenValue, blueValue));
		}
	}
	
	public String calculateEucledian(int r,int b, int g)
	{
	...
	public static void main(String [] args)
	{
		...
		d.calculateDistance("101111010110011011100100");
